...
if AUTOUPDATE then
	 SourceUpdater(SCRIPT_NAME, version, "raw.github.com", "/kihan112/Rythimy-s-BOL-Scripts/master/"..SCRIPT_NAME..".lua", SCRIPT_PATH .. GetCurrentEnv().FILE_NAME, "/kihan112/Rythimy-s-BOL-Scripts/master/VersionFiles/"..SCRIPT_NAME..".version"):CheckUpdate()
end
